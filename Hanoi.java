...
public class Hanoi<AdaptiveCoding> {
    ...
    public static void main(String[] args) {
        ...
        PileEntiers PileDepart = new PileEntiers(); // Création des objets P1,P2,P3
        PileEntiers PileInter = new PileEntiers();
        PileEntiers PileArrive = new PileEntiers();
        int n = saisie();
    ...
    {
        String Depart = PileDepart.toString();

        if (n == 1)
        {
            System.out.println("Deplacement du disque de la "+ PileDepart+" à la pile "+PileArrive);
            return;
        }
